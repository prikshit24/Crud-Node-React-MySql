...
export const DomainAge = (props) => {
    const { tableName, showTable, tableData, DomainAgeSave } = props
        ...
        <>
            ...
            )}
            {
                tableData.map((data, i) => {
                    if (tableName === 'DomainAgeScore' && showTable === true) {
